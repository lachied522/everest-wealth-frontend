...
export default function UserProfile({ data, handleProfileChange, edit }) {
    ...
    >
      <div className={styles["user-profile"]}>
        ...
        <div>
          ...
          <ObjectiveSelector handleProfileChange={handleProfileChange}/>
        </div>
        ...
        <div className="w-form">
            ...
            <div className="flex vertical gap-48px">
              ...
              <div id="industry-prefences-container">
                <div
                  id="w-node-_155c16bb-3068-ff80-a69a-e73f5390dce1-2fdc4015"
                  className="industry-preference-grid-row header"
                >
                  <div id="w-node-_155c16bb-3068-ff80-a69a-e73f5390dce2-2fdc4015"></div>
                  <div className="text-200 color-neutral-700">Dislike</div>
                  <div className="text-200 color-neutral-700">No preference</div>
                  <div className="text-200 color-neutral-700">Like</div>
                </div>
                <div className="industry-preference-grid-row">
                  <div
                    id="w-node-_155c16bb-3068-ff80-a69a-e73f5390dcea-2fdc4015"
                    className="flex align-center"
                  >
                    <img
                      loading="lazy"
                      src="https://uploads-ssl.webflow.com/64afbac816bb17eb2fdc3f03/64afbac916bb17eb2fdc418f_icon-brix-template-Mobile.svg"
                      alt=""
                      className="icon small mg-right-12px"
                    />
                    <div className="text-300 color-neutral-700">Technology</div>
                  </div>
                  <label className="w-checkbox checkbox-field-wrapper">
                    ...
                    <input
                      type="checkbox"
                      id="technology-dislike"
                      name="technology-dislike"
                      data-name="Technology Dislike"
                    />
                    <span className="hidden-on-desktop w-form-label">
                      Placeholder
                    </span>
                  </label>
                  <label className="w-checkbox checkbox-field-wrapper">
                    ...
                    <input
                      type="checkbox"
                      id="checkbox"
                      name="technology-no-preference"
                      data-name="technology-no-preference"
                    />
                    <span className="hidden-on-desktop w-form-label">
                      Placeholder
                    </span>
                  ...
                  <label className="w-checkbox checkbox-field-wrapper">
                    ...
                    <input
                      type="checkbox"
                      id="technology-like"
                      name="technology-like"
                      data-name="Technology Like"
                    />
                    <span className="hidden-on-desktop w-form-label">
                      Placeholder
                    </span>
                ...
                <div className="industry-preference-grid-row technology">
                  <div
                    id="w-node-_155c16bb-3068-ff80-a69a-e73f5390dcfb-2fdc4015"
                    className="flex align-center"
                  >
                    <img
                      loading="lazy"
                      ...
                      className="icon small mg-right-12px"
                    />
                    <div className="text-300 color-neutral-700">Health Care</div>
                  </div>
                  <label className="w-checkbox checkbox-field-wrapper">
                    <div className="w-checkbox-input w-checkbox-input--inputType-custom checkbox"></div>
                    <input
                      type="checkbox"
                      id="health-care-dislike"
                      name="health-care-dislike"
                      data-name="Health Care Dislike"
                    />
                    <span className="hidden-on-desktop w-form-label">
                      Placeholder
                    </span>
                  ...
                  <label className="w-checkbox checkbox-field-wrapper">
                    ...
                    <input
                      type="checkbox"
                      id="health-care-no-preference"
                      name="health-care-no-preference"
                      data-name="Health Care No Preference"
                    />
                    <span className="hidden-on-desktop w-form-label">
                      Placeholder
                    </span>
                  ...
                  <label className="w-checkbox checkbox-field-wrapper">
                    ...
                    <input
                      type="checkbox"
                      id="health-care-like"
                      name="health-care-like"
                      data-name="Health Care Like"
                    />
                    <span className="hidden-on-desktop w-form-label">
                      Placeholder
                    </span>
                ...
                <div className="industry-preference-grid-row technology">
                  <div
                    id="w-node-_155c16bb-3068-ff80-a69a-e73f5390dd0c-2fdc4015"
                    className="flex align-center"
                  >
                    <img
                      loading="lazy"
                      ...
                      className="icon small mg-right-12px"
                    />
                    <div className="text-300 color-neutral-700">Financials</div>
                  </div>
                  <label className="w-checkbox checkbox-field-wrapper">
                    <div className="w-checkbox-input w-checkbox-input--inputType-custom checkbox"></div>
                    <input
                      type="checkbox"
                      id="financials-dislike"
                      name="financials-dislike"
                      data-name="Financials Dislike"
                    />
                    <span className="hidden-on-desktop w-form-label">
                      Placeholder
                    </span>
                  ...
                  <label className="w-checkbox checkbox-field-wrapper">
                    ...
                    <input
                      type="checkbox"
                      id="financials-no-preference"
                      name="financials-no-preference"
                      data-name="Financials No Preference"
                    />
                    <span className="hidden-on-desktop w-form-label">
                      Placeholder
                    </span>
                  ...
                  <label className="w-checkbox checkbox-field-wrapper">
                    ...
                    <input
                      type="checkbox"
                      id="financials-like"
                      name="financials-like"
                      data-name="Financials Like"
                    />
                    <span className="hidden-on-desktop w-form-label">
                      Placeholder
                    </span>
                ...
                <div className="industry-preference-grid-row technology">
                  <div
                    id="w-node-_155c16bb-3068-ff80-a69a-e73f5390dd1d-2fdc4015"
                    className="flex align-center"
                  >
                    <img
                      loading="lazy"
                      ...
                      className="icon small mg-right-12px"
                    />
                    <div className="text-300 color-neutral-700">Materials</div>
                  </div>
                  <label className="w-checkbox checkbox-field-wrapper">
                    <div className="w-checkbox-input w-checkbox-input--inputType-custom checkbox"></div>
                    <input
                      type="checkbox"
                      id="materials-dislike"
                      name="materials-dislike"
                      data-name="Materials Dislike"
                    />
                    <span className="hidden-on-desktop w-form-label">
                      Placeholder
                    </span>
                  ...
                  <label className="w-checkbox checkbox-field-wrapper">
                    ...
                    <input
                      type="checkbox"
                      id="materials-no-preference"
                      name="materials-no-preference"
                      data-name="Materials No Preference"
                    />
                    <span className="hidden-on-desktop w-form-label">
                      Placeholder
                    </span>
                ...
                <div className="industry-preference-grid-row technology">
                  <div
                    id="w-node-_155c16bb-3068-ff80-a69a-e73f5390dd2e-2fdc4015"
                    className="flex align-center"
                  >
                    <img
                      loading="lazy"
                  ...
                  <label className="w-checkbox checkbox-field-wrapper">
                    ...
                    <input
                      type="checkbox"
                      id="disc-no-preference"
                      name="disc-no-preference"
                      data-name="Disc No Preference"
                    />
                    <span className="hidden-on-desktop w-form-label">
                      Placeholder
                    </span>
                ...
                <div className="industry-preference-grid-row technology">
                  <div
                    id="w-node-_155c16bb-3068-ff80-a69a-e73f5390dd3f-2fdc4015"
                    className="flex align-center"
                  >
                    <img
                      loading="lazy"
                  ...
                  <label className="w-checkbox checkbox-field-wrapper">
                    ...
                    <input
                      type="checkbox"
                      id="staples-no-preference"
                      name="staples-no-preference"
                      data-name="Staples No Preference"
                    />
                    <span className="hidden-on-desktop w-form-label">
                      Placeholder
                    </span>
                  ...
                  <label className="w-checkbox checkbox-field-wrapper">
                    ...
                    <input
                      type="checkbox"
                      id="staples-dislike"
                      name="staples-dislike"
                      data-name="Staples Dislike"
                    />
                    <span className="hidden-on-desktop w-form-label">
                      Placeholder
                    </span>
                ...
                <div className="industry-preference-grid-row technology">
                  <div
                    id="w-node-_155c16bb-3068-ff80-a69a-e73f5390dd50-2fdc4015"
                    className="flex align-center"
                  >
                    <img
                      loading="lazy"
                      ...
                      className="icon small mg-right-12px"
                    />
                    <div className="text-300 color-neutral-700">Industrials</div>
                  </div>
                  <label className="w-checkbox checkbox-field-wrapper">
                    <div className="w-checkbox-input w-checkbox-input--inputType-custom checkbox"></div>
                    <input
                      type="checkbox"
                      id="industrials-like"
                      name="industrials-like"
                      data-name="Industrials Like"
                    />
                    <span className="hidden-on-desktop w-form-label">
                      Placeholder
                    </span>
                  ...
                  <label className="w-checkbox checkbox-field-wrapper">
                    ...
                    <input
                      type="checkbox"
                      id="industrials-no-preference"
                      name="industrials-no-preference"
                      data-name="Industrials No Preference"
                    />
                    <span className="hidden-on-desktop w-form-label">
                      Placeholder
                    </span>
                  ...
                  <label className="w-checkbox checkbox-field-wrapper">
                    ...
                    <input
                      type="checkbox"
                      id="industrials-dislike"
                      name="industrials-dislike"
                      data-name="Industrials Dislike"
                    />
                    <span className="hidden-on-desktop w-form-label">
                      Placeholder
                    </span>
                ...
                <div className="industry-preference-grid-row technology">
                  <div
                    id="w-node-_155c16bb-3068-ff80-a69a-e73f5390dd61-2fdc4015"
                    className="flex align-center"
                  >
                    <img
                      loading="lazy"
                      ...
                      className="icon small mg-right-12px"
                    />
                    <div className="text-300 color-neutral-700">Energy</div>
                  </div>
                  <label className="w-checkbox checkbox-field-wrapper">
                    <div className="w-checkbox-input w-checkbox-input--inputType-custom checkbox"></div>
                    <input
                  ...
                  <label className="w-checkbox checkbox-field-wrapper">
                    ...
                    <input
                      type="checkbox"
                      id="energy-no-preference"
                      name="energy-no-preference"
                      data-name="Energy No Preference"
                    />
                    <span className="hidden-on-desktop w-form-label">
                      Placeholder
                    </span>
                ...
                <div className="industry-preference-grid-row technology">
                  <div
                    id="w-node-_155c16bb-3068-ff80-a69a-e73f5390dd72-2fdc4015"
                    className="flex align-center"
                  >
                    <img
                      loading="lazy"
                      ...
                      className="icon small mg-right-12px"
                    />
                    <div className="text-300 color-neutral-700">Real Estate</div>
                  </div>
                  <label className="w-checkbox checkbox-field-wrapper">
                    <div className="w-checkbox-input w-checkbox-input--inputType-custom checkbox"></div>
                    <input
                      type="checkbox"
                      id="real-estate-like"
                      name="real-estate-like"
                      data-name="Real Estate Like"
                    />
                    <span className="hidden-on-desktop w-form-label">
                      Placeholder
                    </span>
                  ...
                  <label className="w-checkbox checkbox-field-wrapper">
                    ...
                    <input
                      type="checkbox"
                      id="real-estate-no-preference"
                      name="real-estate-no-preference"
                      data-name="Real Estate No Preference"
                    />
                    <span className="hidden-on-desktop w-form-label">
                      Placeholder
                    </span>
                  ...
                  <label className="w-checkbox checkbox-field-wrapper">
                    ...
                    <input
                      type="checkbox"
                      id="real-estate-dislike"
                      name="real-estate-dislike"
                      data-name="Real Estate Dislike"
                    />
                    <span className="hidden-on-desktop w-form-label">
                      Placeholder
                    </span>
                ...
                <div className="industry-preference-grid-row technology">
                  <div
                    id="w-node-_155c16bb-3068-ff80-a69a-e73f5390dd83-2fdc4015"
                    className="flex align-center"
                  >
                    <img
                      loading="lazy"
                      ...
                      className="icon small mg-right-12px"
                    />
                    <div className="text-300 color-neutral-700">Utilities</div>
                  </div>
                  <label className="w-checkbox checkbox-field-wrapper">
                    <div className="w-checkbox-input w-checkbox-input--inputType-custom checkbox"></div>
                    <input
                  ...
                  <label className="w-checkbox checkbox-field-wrapper">
                    ...
                    <input
                      type="checkbox"
                      id="utilities-no-preference"
                      name="utilities-no-preference"
                      data-name="Utilities No Preference"
                    />
                    <span className="hidden-on-desktop w-form-label">
                      Placeholder
                    </span>
                  ...
                  <label className="w-checkbox checkbox-field-wrapper">
                    ...
                    <input
                      type="checkbox"
                      id="utilities-dislike"
                      name="utilities-dislike"
                      data-name="Utilities Dislike"
                    />
                    <span className="hidden-on-desktop w-form-label">
                      Placeholder
                    </span>
