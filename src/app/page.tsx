  ...
  return (
    <main className="h-full">
      ...
      <div className="h-[90vh] relative bg-gradient-to-b from-transparent from-70% to-white">
        ...
        <div className="flex items-center justify-center px-24 2xl:px-48 inset-y-0 absolute">
      ...
      <div className="flex flex-col items-center justify-center bg-blue-300 px-24 py-48 lg:px-36 gap-24">
        <h2 className="text-4xl font-bold mb-24">The Solution</h2>
        ...
        <div className="grid grid-cols-2 place-items-center">
          <div className="max-w-[60%] flex flex-col items-center gap-6">
            <div className="flex flex-col gap-4 mb-6">
              ...
              <p className="text-lg">Let us help you on your investing journey.</p>
            </div>
            <div className="flex gap-4">
              <Link href='/login'>
                <Button variant="secondary">
