...
function formatSector(sectorString) {
...
export default async function Page({ params }) {
    ...
    const domestic = data['domestic'].toLowerCase()==="true";
        ...
        <>
            <div className="mb-16">
                <div className="flex justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        {domestic ? <GiAustralia size={21} color="black"/> : <LuGlobe2 size={21} color="black"/>}
                    </div>
            ...
            <div className="flex flex-col items-stretch gap-4">
                ...
                <div className="w-full flex items-center">
                    <TradingViewNewsWidget symbol={domestic? `ASX:${data['symbol']}`: `NASDAQ:${data['symbol']}`} />
                </div>
            </div>
        </>
    )
