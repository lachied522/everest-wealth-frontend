...
const Objective = ({ name, iconSrc, text, timeHorizon, selected, handleChange }: ObjectiveProps) => {
...
export default function ObjectiveSelector({ value, handleChange }: ObjectiveSelectorProps) {
