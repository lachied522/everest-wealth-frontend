...
export const FormSchema = z.object({
    ...
    employment: z.string({
        required_error: "Please your employment type"
    }).nullable(),
    salary: z.coerce.number({
        required_error: "Please your salary"
    }).nullable(),
    assets: z.coerce.number({
        required_error: "Please your assets"
    }).nullable(),
    borrowing: z.coerce.boolean().nullable(),
    experience: z.coerce.number({
        required_error: "Please your experience level"
    }).nullable(),
        ...
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="max-w-6xl flex flex-col items-center gap-6 p-6 space-y-8">
                ...
                <Card className="flex flex-col gap-12 items-center p-16 m-4">
                    ...
                    <h3 className="text-2xl font-medium">Risk Tolerance</h3>
                    <div className="flex flex-col items-stretch gap-24 p-16 m-4">
